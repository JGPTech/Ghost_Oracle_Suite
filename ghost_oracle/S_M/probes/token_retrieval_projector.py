...
"""
===============================================================================
TOKEN RETRIEVAL PROJECTOR — FINAL BENCHMARK RUNNER
===============================================================================

Purpose
-------
Final token-retrieval benchmark runner for the Ghost Oracle Suite.
...
def main() -> None:
    ...
    out_dir = Path(args.out_dir) if args.out_dir else ANALYSIS_DIR / f"token_retrieval_projector_{now_tag()}"
    out_dir.mkdir(parents=True, exist_ok=True)

    print(f"\n{'=' * 128}")
    print("  TOKEN RETRIEVAL PROJECTOR EXAMPLE — CLASSICAL vs PROJECTED")
    print(f"{'=' * 128}")
