...
Drop this file in:
    ...
    ghost_oracle/D_M/probes/d_m_task_utility_retrieval_gpu_benchmark.py
...
def main() -> None:
    ...
    tag = now_tag()
    out_dir = args.out_dir or (ANALYSIS_DIR / f"dm_probe_19_task_utility_retrieval_gpu_{tag}")
    ...
    write_json(
        ...
        {
            "script": "d_m_task_utility_retrieval_gpu_benchmark.py",
            "timestamp": tag,
            "gpu_only": True,
            "cpu_fallback": False,
            "d_m_dir": D_M_DIR,
