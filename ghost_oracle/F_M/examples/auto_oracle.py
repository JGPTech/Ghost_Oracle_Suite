...
def main():
    ...
    p.add_argument("--data", default=str(HERE.parent / "data"))
    p.add_argument("--kernel", default=str(HERE.parent / "kernels" / "ghost_kernel.cu"))
    p.add_argument("--mk-kernel", default=str(HERE.parent / "kernels" / "megakernels_2d.cu"))
